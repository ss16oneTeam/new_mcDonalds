...
<script type="text/javascript">
	...
	/*]]>*/
		...
		<script>
			...
			var selectedmenu = '일반 메뉴';
			var selectedcategory = "추천 메뉴";
							...
							<div id="product-cards" class="product-cards" data-equal-height=".product-card--standard .product-title, .product-card--standard .product-info">
								<div class="row row-narrow">
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/4946.png?" class="img-block">
													...
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 8,800</span>
																</div>
																<div class="product-nutritional-info">
																	
																	
																								
																		<span class="text-default">967~1116 Kcal</span>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>보성녹돈 버거</h4>
																<div>보성녹돈 버거 (난류, 우유, 대두, 밀, 돼지고기, 토마토), 후렌치 후라이 (대두), 케첩 (토마토)</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;보성녹돈 버거&quot;,'id':'4946','price':'8800.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/2061.png?" class="img-block">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																...
																<div class="product-nutritional-info">
																		...
																		<span class="text-default">927~1076 Kcal</span>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>맥크리스피™ 디럭스 버거</h4>
																<div>맥크리스피™ 디럭스 버거 (난류, 우유, 대두, 밀, 토마토, 닭고기, 쇠고기), 후렌치 후라이 (대두), 케첩 (토마토)</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;맥크리스피™ 디럭스 버거&quot;,'id':'2061','price':'8800.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/2031.png?" class="img-block">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 8,000</span>
																</div>
																<div class="product-nutritional-info">
																	
																	
																								
																		<span class="text-default">916~1065 Kcal</span>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>맥크리스피™ 클래식 버거</h4>
																<div>맥크리스피™ 클래식 버거 (난류, 우유, 대두, 밀, 토마토, 닭고기, 쇠고기), 후렌치 후라이 (대두), 케첩 (토마토)</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;맥크리스피™ 클래식 버거&quot;,'id':'2031','price':'8000.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/6333.png?" class="img-block">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 8,100</span>
																</div>
																<div class="product-nutritional-info">
																	
																	
																								
																		<span class="text-default">951~1100 Kcal</span>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>트리플 치즈버거</h4>
																<div>트리플 치즈버거 (우유, 대두, 밀, 토마토, 쇠고기), 후렌치 후라이 (대두), 케첩 (토마토)</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;트리플 치즈버거&quot;,'id':'6333','price':'8100.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/5284.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">맥딜리버리 투게더팩</h5>
													<div class="product-badges">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 17,000</span>
																</div>
																<div class="product-nutritional-info">
																	
																	
																								
																		<span class="text-default">1916~2214 Kcal</span>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>맥딜리버리 투게더팩</h4>
																<div>투게더팩에 포함되는 제품 별 알레르기 정보는 단일 메뉴 정보를 참고해 주시기 바랍니다.</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;맥딜리버리 투게더팩&quot;,'id':'5284','price':'17000.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/1477.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">맥윙™ 2조각</h5>
													<div class="product-badges">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 3,700</span>
																</div>
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">245 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>맥윙™ 2조각</h4>
																				<div>중량 84 g 열량 245 Kcal 당 0 g (0%) 단백질 15 g (27%) 포화지방 3 g (20%) 나트륨 678 mg (34%)</div>
																			</div>
																		</div>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>맥윙™ 2조각</h4>
																<div>맥윙™ (난류, 대두, 밀, 닭고기), 스위트칠리 소스 (토마토), 스위트 앤 사워 소스 (대두, 밀, 아황산류, 굴), 케이준 소스 (난류, 대두)</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;맥윙™ 2조각&quot;,'id':'1477','price':'3700.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/6154.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">치킨 토마토 스낵랩</h5>
													<div class="product-badges">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 2,800</span>
																</div>
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">264 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>치킨 토마토 스낵랩</h4>
																				<div>중량 142 g 열량 264 Kcal 당 6 g (6%) 단백질 10 g (18%) 포화지방 3 g (17%) 나트륨 749 mg (37%)</div>
																			</div>
																		</div>
														...
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>치킨 토마토 스낵랩</h4>
																<div>치킨 토마토 스낵랩 (난류, 우유, 대두, 밀, 토마토, 닭고기, 쇠고기, 굴)</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;치킨 토마토 스낵랩&quot;,'id':'6154','price':'2800.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/3248.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">레몬 맥피즈 코카-콜라</h5>
													<div class="product-badges">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 2,600</span>
																</div>
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">216 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>레몬 맥피즈 코카-콜라</h4>
																				<div>중량 425 ml 열량 216 Kcal 당 51 g (51%) 단백질 0 g (0%) 포화지방 0 g (0%) 나트륨 13 mg (1%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;레몬 맥피즈 코카-콜라&quot;,'id':'3248','price':'2600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/3253.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">레몬 맥피즈 코카-콜라 제로</h5>
													<div class="product-badges">
													...
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																...
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">115 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>레몬 맥피즈 코카-콜라 제로</h4>
																				<div>중량 425 ml 열량 115 Kcal 당 26 g (26%) 단백질 0 g (0%) 포화지방 0 g (0%) 나트륨 29 mg (1%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;레몬 맥피즈 코카-콜라 제로&quot;,'id':'3253','price':'2600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/3250.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">레몬 맥피즈 스프라이트</h5>
													<div class="product-badges">
													...
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																...
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">220 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>레몬 맥피즈 스프라이트</h4>
																				<div>중량 425 ml 열량 220 Kcal 당 53 g (53%) 단백질 0 g (0%) 포화지방 0 g (0%) 나트륨 21 mg (1%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;레몬 맥피즈 스프라이트&quot;,'id':'3250','price':'2600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/3198.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">허쉬 프레첼 맥플러리</h5>
													<div class="product-badges">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 3,600</span>
																</div>
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">400 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>허쉬 프레첼 맥플러리</h4>
																				<div>중량 192 g 열량 400 Kcal 당 51 g (51%) 단백질 7 g (13%) 포화지방 8 g (53%) 나트륨 183 mg (9%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;허쉬 프레첼 맥플러리&quot;,'id':'3198','price':'3600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/1889.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">제주 한라봉 칠러</h5>
													<div class="product-badges">
													...
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																...
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">236 kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>제주 한라봉 칠러</h4>
																				<div>중량 400 ml 열량 236 kcal 당 40 g (40%) 단백질 1 g (1%) 포화지방 0 g (0%) 나트륨 48 mg (2%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;제주 한라봉 칠러&quot;,'id':'1889','price':'3600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/1845.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">애플망고 칠러</h5>
													<div class="product-badges">
													...
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																...
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">251 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>애플망고 칠러</h4>
																				<div>중량 400 ml 열량 251 kcal 당 52 g (52%) 단백질 0 g (1%) 포화지방 0 g (1%) 나트륨 23 mg (1%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;애플망고 칠러&quot;,'id':'1845','price':'3600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/1630.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">자두 칠러</h5>
													<div class="product-badges">
													...
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																...
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">198 kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>자두 칠러</h4>
																				<div>중량 400 ml 열량 198 kcal 당 31 g (31%) 단백질 0 g (1%) 포화지방 0 g (1%) 나트륨 54 mg (3%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;자두 칠러&quot;,'id':'1630','price':'3600.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
										...
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/products/3213.png?" class="img-block">
													<h5 class="product-title" style="height: auto;">바닐라 라떼</h5>
													<div class="product-badges">
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: auto;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ 4,000</span>
																</div>
																<div class="product-nutritional-info">
																		...
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">227 Kcal</span>
																				
																		</a>
																		<div class="popover-details">
																			<div class="popover-wrapper">
																				<h4>바닐라 라떼</h4>
																				<div>중량 365 ml 열량 227 Kcal 당 28 g (28%) 단백질 8 g (14%) 포화지방 5 g (30%) 나트륨 79 mg (4%)</div>
																			</div>
																		</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<!-- MDSAP-11470 - INC10164449 Google Analytics data is missing due to incorrect implementation. -->
																<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																<a data-productid="789" class="btn btn-block action-create btn-yellow" href="../guest_address.html?from=browsemenu" onclick="onProductClick({ 'name':&quot;바닐라 라떼&quot;,'id':'3213','price':'4000.0','brand':'McDonalds','cat':&quot;추천 메뉴&quot;,'variant':'','url':'#signin'})">Order</a>
							...
							<div class="panel panel-basic panel-narrow">
								<div class="panel-section-group">
									<section class="panel-section how-it-works">
										<a href="#signin" data-toggle="modal" data-target="#signin"><img src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/82/img/how_mcdelivery_works_portrait_ko.png"></a>
									</section>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<input type="hidden" name="csrfValue" value="5fe5f60c10b53e2f37ebcaf16a138829"></form>
											...
											<div class="modal-body">
												<div class="row">
													<div class="col-xs-3 timer-wrapper">
														...
														<div class="time timer text-din timer-clock session-timer">14:40</div>
			...
			$(document).on('ready', function() {
				...
				if(isPlexureAuthEnabled){
					$.ajaxPrefilter(function(options, originalOptions, jqXHR) {
						jqXHR.setRequestHeader("csrfValue", '5fe5f60c10b53e2f37ebcaf16a138829');
					});
...
<div id="wp_tg_cts" style="display:none;"><script id="wp_tag_script_1657450651768" src="https://astg.widerplanet.com/delivery/wpc.php?v=1&amp;ver=4.0&amp;r=1&amp;md=bs&amp;ga=1h9ugk7-1jln02t-3-1&amp;wp_uid=2-95ef5ede730700e429946b9c1937978b-s1651402229.624000%7Cwindows_10%7Cchrome-3s21dj&amp;ty=Item&amp;ti=28160&amp;i0=%EC%83%81%ED%92%88ID&amp;t0=%EC%83%81%ED%92%88%EB%AA%85&amp;device=web&amp;charset=UTF-8&amp;tc=1657450651768&amp;ref=https%3A%2F%2Fwww.mcdelivery.co.kr%2Fkr%2F&amp;loc=https%3A%2F%2Fwww.mcdelivery.co.kr%2Fkr%2Fbrowse%2Fmenu.html"></script></div>
...
<script type="text/javascript">
	...
	/*]]>*/
		...
		<script>
			...
			function onProductRemoveClick(productObj){
				dataLayer.push({
			...
			var _products = [];
			//execute when production dimension dialog appear
			/*<![CDATA[*/ 
			function pushComponentsInfo(prods)
			{
				//console.log("~~~1");
				//console.log(prods);
				_products = [];
				$(prods).each(function(i, n){
					var _prod = {};
					//if(typeof n.components != "undefined" && n.components.length > 0)
					//{
					//	_prod.name = n.components[0].cartName;
					//}else{
						_prod.name = n.cartName;
					//}
					_prod.id = n.productCode.toString();
					_prod.price = n.originalPrice.toString();
					_prod.brand = 'McDonalds';
					_prod.category = selectedcategory;
					_prod.variant = n.variationName;
					console.log(n);
			...
			function pushAddItemInfo(items)
			{
				//console.log("~~~2");
				//console.log(items);
				if(_products.length > 0)
				{
					...
					{
						var n = items.cartItems[i];
						var itemexist = false;
						for(var j=0; j<_items.length; j++)
						{
							if(n.productCode.toString() == _items[j].id)
							{
								_items[j].quantity++;
								itemexist = true;
								break;
						...
						if(!itemexist)
						{
							...
							{
								var m = _products[j];
								if(n.productCode.toString() == m.id)
								{
									var _item = {};
									_item.name = m.name;
									_item.id = m.id;
									_item.price = m.price;
									_item.brand = m.brand;
									_item.category = m.category;
									_item.variant = m.variant;
									_item.quantity = 1;
									_items.push(_item);
									break;
								}
				...
				<div class="header-actions row">
					...
					<div class="my-account-quicklinks">
						...
						<li class="list-item">
								...
								<a class="list-item-target" onclick="          dataLayer.push({           'event':'logout'          });         " href="../md/md_logout.jsp">로그아웃</a>
												...
												<fieldset class="fieldset fieldset-deliveryaddress">
													...
													<div class="form-group">
														<select class="hide-default-error" name="address" id="form_deliveryoptions_address" aria-disabled="false" tabindex="0" style="display: none;">
															<option selected="selected" value="1">${Member.adr_code}</option>
														</select><span class="hide-default-error"><a class="ui-selectmenu ui-widget ui-state-default ui-corner-all ui-selectmenu-dropdown" id="form_deliveryoptions_address-button" role="button" href="#nogo" tabindex="0" aria-haspopup="true" aria-owns="form_deliveryoptions_address-menu" aria-disabled="false" style="width: 0px;"><span class="ui-selectmenu-status">${Member.adr_code}</span><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span></a></span>
